        ...
        for alert in alerts:
            ...
            if should_act:
                ...
                action_map = {
                    ...
                    "Kabinentemperatur zu niedrig": "ENTSCHEIDUNG: Produktion pausiert | FOLGESCHRITTE: IR-Heizstrahler auf Maximum, Vorheizzeit von 3min auf 8min erhöht, Werkstücke in Warteposition, Schichtleiter benachrichtigt, Produktion bei 20°C freigegeben",
                    ...
                    "Energieverbrauch zu niedrig": "ENTSCHEIDUNG: NOTFALL - Produktionslinie GESTOPPT | FOLGESCHRITTE: Roboter in Sicherheitsposition gefahren, Lackpumpen abgeschaltet, Instandhaltung alarmiert, Fehlerdiagnose gestartet, Schichtleiter informiert, Neustart nur nach Freigabe",
